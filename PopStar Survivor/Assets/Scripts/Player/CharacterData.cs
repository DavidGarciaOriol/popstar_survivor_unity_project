...
[CreateAssetMenu(fileName = "CharacterData", menuName = "PSS2D Rogue-like/Character Data")]
public class CharacterData : ScriptableObject
{
    ...
    public struct Stats
    {
        ...
        public Stats(float maxHealth = 100, float recovery = 0, float moveSpeed = 1f, float might = 1f, float speed = 1f, float magnet = 1f)
        {
